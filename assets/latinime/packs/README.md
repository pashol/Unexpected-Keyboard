...
whose manifest, output hash, acquisition lock, and external-corpus provenance
verify. A ready GSW pack also requires its CC BY-NC-SA 4.0 non-commercial and
ShareAlike attribution notice.
